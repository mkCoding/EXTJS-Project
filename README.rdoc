...
Summary:
  ...
  This application demonstrates my skill utilizing Extensive Javascript framework/libraries. This application simply 
  takes values from input fields and adds them to a grid
