...
What was used to develop the application:
 Eclipse (Keplar)
 HTML and Extensive Javascript
 
Summary:

  This application demonstrates my skill utilizing Extensive Javascript 
  framework/libraries. This application simply takes values from input fields
  and adds them to a grid.
...
http://benemly40.appspot.com/
 ...
 Next add some values to 1 or more of the components within the field set
 After the information is entered press the Display button to add data to the grid


Notes:

 The ExtJS libraries/framewords were used from the sencha links below:
